...
locations = [
    ...
    "Leoforou Marathonos 28, Anixi 14569, Greece",
    ...
    "Leoforou Aleksandras 119, Athina 11475, Greece",
    "Erythrou Stavrou 2, Athina 11526, Greece",
    "Leoforou Kifisias 5, Athina 11523, Greece",
    "Leoforos Mesogion 264, Cholargos 15562, Greece",
    "Sevastoupoleos 150, Athina 11526, Greece",
    "Leoforos Mesogion 107, Athina 11526, Greece",
    ...
    "Leoforou Galatsiou 50, Athina 11141, Greece",
    "Therianou 4, Athina 11473, Greece",
    "Ioannou Foka 85, Athina 11142, Greece",
...
# Initialize an empty list to store the time matrix
time_matrix_data = []
...
for origin in locations:
    ...
    while len(locations) > totalLocationsChecked:
        ...
        url = f"https://api.distancematrix.ai/maps/api/distancematrix/json?origins={origin}&destinations={testd}&traffic_model=pessimistic&departure_time=1711357200&key={API_KEY}"
        ...
        if 'rows' in data and len(data['rows']) > 0:
            ...
            for element in row['elements']:
                if 'duration_in_traffic' in element:
                    duration_in_traffic = element['duration_in_traffic']['value'] / 60  # Convert duration from seconds to minutes

                    # Populate the matrix DataFrame with the extracted durations
                    distance_matrix_df.at[origin, element["destination"]] = round(duration_in_traffic)
